...
public class Controller {
    ...
    /**
     * Checks if myGame hs placed all its Ships
    ...
    /**
     * Creates a Writer for Saving a Game in s File and a Timestamp as NAme for that File
     */
    ...
    /**
     * Passes to a DocumentWriter writer all necessary Information to save a Game
     */
    public void save() {
    ...
    /**
     * Recreates the Game form the File. Each Line is split into an Array with one word or Number for
     * an Index. Then according to what the word is in [0] the Information is processed and set to the right Variables
     * If necessary new Instances are created.
     */
